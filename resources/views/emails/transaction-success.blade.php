                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:180px;">
                                                <img alt="" height="auto"
                                                     src="{{asset('frontend/Images/output-onlinepngtools.png')}}"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071c42;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style=""
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c42;">
                                                    Hi, {{$data->user->name}} <br><br> Tiket digital kamu sudah berhasil
                                                    dicetak. <br> Booking ID <strong> #{{$data->id}}</strong></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                       style="color:#071c42;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                    <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#ff9e53" role="presentation"
                                                            ...
                                                            valign="middle">
                                                            <a href="{{ route('checkout_process',$data->id) }}"
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                        ...
                                        <tr>
                                            <td style="width: 50px">
                                                <img src="{{asset('frontend/Images/support.png')}}" alt=""
                                                     width="40px"></img>
                                            </td>
                                            <td style="font-size: 18px; color: #071c4d"
                                                font-family="Assistant, Helvetica, Arial, sans-serif">
                                                supports@travelria.id <br> 082248751865
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        ...
                                        2019 © Travelria.id Copyright All rights reserved.
                                    </div>
                                </td>
                            </tr>
                            </tbody>
